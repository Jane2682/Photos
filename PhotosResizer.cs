...
namespace Photos//funkcija kas maina attela izmeru pret videjo vai maza izmera
{
    public static class PhotosResizer
    {
        [FunctionName("PhotosResizer")]
        public static async Task Run([BlobTrigger("photos/{name}", Connection = Literals.StorageConnectionString)]
        Stream myBlob,
