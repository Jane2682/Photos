...
namespace Photos
{
    ...
    {
        [FunctionName("PhotosSearch")]//funkcija kas mekle visus objektus ar ievaditiem datiem meklesanas kriterija
        //kas atbilst objekta aprakstam un atgriez rezultatu List saraksta
            ...
            ILogger logger)
        {
            ...
            var results = new List<dynamic>();// dinamiskais saraksts kur tiek atgriezts rezultats

            while (query.HasMoreResults)//iteracija visiem rezultaciem cauri
            {
